...
import { FileiraDeSetas, Globo } from './Grafismo';
...
/**
 * O cartaz de abertura roda em dois lugares: na entrada pública e na home de
 * quem já entrou. O texto é o mesmo nos dois — é o que a plataforma é —, e só
 * os botões mudam: quem está de fora precisa criar conta, quem está dentro
 * precisa de um caminho pra dentro do que já existe.
 */
    ...
    <>
      <section className="faixa faixa--preto">
        <div className="faixa__interno">
          ...
          <div className="acoes">
            {dentro ? (
              <>
                <Link className="botao botao--amarelo" to="/pessoas">
                  <span className="seta" aria-hidden="true" />
                  Ver a turma
                </Link>
                <Link className="botao botao--contorno" to="/projetos">Ver o mural</Link>
              </>
            ) : (
              <>
      ...
      <section className="faixa faixa--vermelho">
        <div className="faixa__interno">
          ...
          <div className="acoes">
            <Link className="botao botao--preto" to={dentro ? '/projetos/novo' : '/criar-conta'}>
              <span className="seta" aria-hidden="true" />
              {dentro ? 'Publicar meu projeto' : 'Começar pelo meu perfil'}
            </Link>
          </div>
        </div>
      </section>
